        ...
        <div class="row">
            <div class="col-md-12">
                @if ($home_ads->above_search_ad_url == '')
                    <img src="{{ asset('uploads/' . $home_ads->above_search_ad) }}" alt="">
                @else
                <a href="{{ $home_ads->above_search_ad_url }}"><img src="{{ asset('uploads/' . $home_ads->above_search_ad) }}" alt=""></a>
                @endif 
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                @else
                <a href="{{ $home_ads->above_footer_ad_url }}"><img src="{{ asset('uploads/' . $home_ads->above_footer_ad) }}" alt=""></a>
                @endif 
            </div>
        </div>
    </div>
        ...
        $(document).ready(function(){
             $("#category").on("change" , function(){
                  ...
                  if(category_id){
                      $.ajax({
                         type : "get",
                         url : "{{ url('/subcategory-by-category') }}" + "/" + category_id,
