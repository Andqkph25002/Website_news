        ...
        <div class="top">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <ul>
                            <li class="today-text">Today: January 23, 2023</li>
                            <li class="email-text">andqkph25002@fpt.edu.vn</li>
                        </ul>
                    </div>
                    <div class="col-md-6">
                        <ul class="right">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="ad-section-1">
                            @if ($global_top_ad_data->top_ad_url == '')
                                <img src="{{ asset('uploads/' . $global_top_ad_data->top_ad) }}" height="40" alt="">
                            @else
                                <a href="{{ $global_top_ad_data->top_ad_url }}"><img src="{{ asset('uploads/' . $global_top_ad_data->top_ad) }}" height="40" alt=""></a>
                            @endif
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="item">
                            ...
                            <ul class="social">
                                @foreach ($global_socail_item_data as $item)
                    ...
                    <div class="col-md-3">
                        <div class="item">
                            ...
                            <form action="{{ route('subscriber') }}" method="post" class="form_subscriber_ajax">
                               @csrf
