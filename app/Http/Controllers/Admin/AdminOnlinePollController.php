...
class AdminOnlinePollController extends Controller
{
    public function show()
    {
        ...
        return view('admin.OnlinePoll.show', compact('online_poll_data'));
    }

    public function create()
    {
        return view('admin.OnlinePoll.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.OnlinePoll.edit', compact('online_poll_data'));
    }
