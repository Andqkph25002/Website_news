...
class AdminSocialItemController extends Controller
{
    public function show()
    {
        ...
        return view('admin.SocialItem.show', compact('social_item_data'));
    }
    public function create(){
        return view('admin.SocialItem.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.SocialItem.edit', compact('social_item_data'));
    }
